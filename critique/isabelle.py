...
class IsabelleCritique(CritiqueModel):
    def __init__(self, generative_model, isabelle_session,
                 ...
                 prompt_dict: Optional[dict] = None, port: Optional[int] = None, isabelle_name: Optional[str] = None):
        ...
        self.isabelle_name = isabelle_name or (
            datetime.now().strftime("%Y%m%d%H%M%S") + str(random.randint(0, 9_999_999))
        )
        self.port = port
    ...
    def pass_error_to_main(self, error_message: str):
    ...
    def _init_client(self):
        try:
            ...
            self.pass_error_to_main(f"Error starting Isabelle server: {e}")
    ...
    def _init_session(self):
        try:
            ...
            self.pass_error_to_main(f"Error initializing session: {e}")
    ...
    def check_syntax_error(self, theory_name, master_dir, isabelle_code):
        ...
        if finished_response is not None:
            ...
            self.pass_error_to_main("Wrong theory name")
